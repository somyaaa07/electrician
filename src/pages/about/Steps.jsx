      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 sm:mb-16">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-slate-900 mb-4 font-serif">
            Our <span className="text-[#009999]">Process</span>
          </h1>
        ...
        <div className="mb-12">
          <div className="relative">
            ...
            {/* Progress Bar Fill */}
            <div 
              className="absolute top-8 left-0 h-2 bg-[#009999] rounded-full mx-8 sm:mx-12 transition-all duration-500 ease-in-out"
                ...
                <div key={step.id} className="flex flex-col items-center z-10">
                  <button
                    ...
                    className={`w-16 h-16 sm:w-20 sm:h-20 rounded-full border-4 bg-white flex items-center justify-center transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-110 ${
                      index <= currentStep
                        ? 'border-[#009999] bg-[#009999] text-white'
                        : 'border-gray-300 text-gray-400 hover:border-[#009999]/50'
                    } ${
                  ...
                  <div className="mt-4 text-center">
                    <p className={`text-sm sm:text-base font-semibold transition-colors duration-300 ${
                      index <= currentStep ? 'text-[#009999]' : 'text-gray-500'
                    }`}>
                      {step.title}
                    </p>
                  </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
          <div className="p-6 sm:p-8 md:p-10">
            ...
            <div className="flex items-center gap-4 mb-6">
              <div className="w-16 h-16 bg-[#009999]/10 rounded-lg flex items-center justify-center">
                <div className="text-[#009999]">
              ...
              <button
                ...
                className={`px-6 py-3 rounded-lg font-semibold transition-all duration-300 flex items-center gap-2 ${
                  currentStep === 0
                    ...
                    : 'bg-white border-2 border-[#009999] text-[#009999] hover:bg-[#009999] hover:text-white shadow-md hover:shadow-lg'
                }`}
              >
              ...
              <button
                ...
                className={`px-6 py-3 rounded-lg font-semibold transition-all duration-300 flex items-center gap-2 ${
                  currentStep === steps.length - 1
                    ? 'bg-gray-100 text-gray-400 cursor-not-allowed'
                    : 'bg-[#009999] text-white hover:bg-[#1a9994] shadow-md hover:shadow-lg'
                }`}
              >
                Next
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {steps.map((step, index) => (
            <div
              ...
              className={`p-4 rounded-xl border-2 transition-all duration-300 cursor-pointer ${
                index === currentStep
                  ? 'border-[#009999] bg-[#009999]/5 shadow-lg'
                  : 'border-gray-200 hover:border-[#009999]/50 hover:shadow-md'
              }`}
            >
              <div className="flex items-center gap-3">
                <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                  index === currentStep ? 'bg-[#009999] text-white' : 'bg-gray-100 text-gray-600'
                }`}>
                  {step.icon}
                </div>
                <div>
                  ...
                  <p className={`text-sm font-semibold ${
                    index === currentStep ? 'text-[#009999]' : 'text-gray-700'
                  }`}>
                    {step.title}
                  </p>
                </div>
