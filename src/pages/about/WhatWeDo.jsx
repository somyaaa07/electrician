        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-8">
              ...
              <div className="flex items-center gap-2 bg-[#20B2AA]/10 px-6 py-3 rounded-full">
                <Cpu className="w-5 h-5 text-[#20B2AA]" />
                    ...
                    <div className="space-y-2">
                      {industry.highlights.map((highlight, idx) => (
                        <div key={idx} className="flex items-start gap-2">
                          <div className="w-1.5 h-1.5 rounded-full bg-[#20B2AA] mt-1.5 flex-shrink-0"></div>
          ...
          <div className="mt-16 text-center">
            <div className="inline-block bg-[#20B2AA]/10 rounded-2xl p-8 max-w-3xl">
              ...
              <button className="bg-[#20B2AA] text-white px-8 py-3 rounded-full font-semibold hover:bg-[#1a9690] transition-colors duration-300 shadow-lg">
                Get Started Today
              </button>
            </div>
          </div>
