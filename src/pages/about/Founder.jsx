      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-3 mb-4">
            <Zap className="w-8 h-8" style={{ color: '#009999' }} />
            <h2 className="text-4xl font-bold" style={{ color: '#009999' }}>
              Meet Our Founder
            </h2>
            <Zap className="w-8 h-8" style={{ color: '#009999' }} />
          </div>
          <div className="w-24 h-1 mx-auto" style={{ backgroundColor: '#009999' }}></div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <div 
              ...
              style={{ backgroundColor: '#009999', opacity: 0.2 }}
            ></div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-xl font-medium" style={{ color: '#009999' }}>
            ...
            <div className="grid grid-cols-3 gap-4 pt-6">
              <div className="text-center p-4 rounded-lg" style={{ backgroundColor: '#00999910' }}>
                <Award className="w-8 h-8 mx-auto mb-2" style={{ color: '#009999' }} />
                <div className="text-sm font-semibold text-gray-700">Safety First</div>
              </div>
              <div className="text-center p-4 rounded-lg" style={{ backgroundColor: '#00999910' }}>
                <TrendingUp className="w-8 h-8 mx-auto mb-2" style={{ color: '#009999' }} />
                <div className="text-sm font-semibold text-gray-700">Performance</div>
              </div>
              <div className="text-center p-4 rounded-lg" style={{ backgroundColor: '#00999910' }}>
                <Zap className="w-8 h-8 mx-auto mb-2" style={{ color: '#009999' }} />
            ...
            <div className="grid grid-cols-3 gap-6 pt-6">
              <div className="text-center">
                <div className="text-3xl font-bold" style={{ color: '#009999' }}>
                  500+
                </div>
            ...
            {/* Quote */}
            <div className="border-l-4 pl-6 py-4 mt-8 rounded-r-lg" style={{ borderColor: '#009999', backgroundColor: '#00999905' }}>
        ...
        {/* Vision Statement */}
        <div className="mt-16 p-8 rounded-2xl" style={{ backgroundColor: '#00999910' }}>
          <div className="max-w-4xl mx-auto text-center">
            <h3 className="text-2xl font-bold mb-4" style={{ color: '#009999' }}>
              Our Vision
            </h3>
