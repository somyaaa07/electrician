      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-center gap-4 mb-12 flex-wrap">
          {Object.keys(sections).map((key) => (
            <button
              ...
              style={{
                backgroundColor: activeTab === key ? '#20B2AA' : undefined,
          ...
          {Object.keys(sections).map((key) => (
            ...
            >
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-3xl p-12 shadow-xl border border-gray-100">
                {/* Section Header */}
                <div className="flex items-center gap-4 mb-8 pb-6 border-b-2" style={{ borderColor: '#20B2AA' }}>
        ...
        <div className="mt-16 flex justify-center">
          <div className="flex items-center gap-2">
            <div className="w-12 h-1 rounded-full" style={{ backgroundColor: '#20B2AA' }}></div>
