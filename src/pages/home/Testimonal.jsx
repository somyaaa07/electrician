    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-white">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto transition-all duration-700 ease-in-out">
            {getCurrentTestimonials().map((testimonial, index) => (
              <div 
                ...
                className="relative bg-gray-50/90 backdrop-blur-md rounded-2xl p-8 shadow-xl border border-gray-200 hover:bg-gray-100/90 hover:border-[#009999] transition-all duration-300 hover:scale-105 flex flex-col animate-fadeIn"
              >
                <Quote className="absolute top-6 left-6 w-12 h-12 text-[#009999]/20" />
                
                <div className="relative flex-1 flex flex-col">
                  <div className="flex gap-1 mb-6 justify-center">
                    {[...Array(testimonial.rating)].map((_, i) => (
                      <Star key={i} className="w-5 h-5 fill-[#009999] text-[#009999]" />
                    ))}
                  </div>
                  ...
                  <div className="flex items-center justify-center gap-4">
                    <div className="w-14 h-14 rounded-full bg-[#009999]/20 flex items-center justify-center border-2 border-[#009999]">
                      <span className="text-[#009999] font-semibold text-lg">{testimonial.image}</span>
                    </div>
        ...
        <div className="flex items-center justify-center gap-6 mt-12">
          <button 
            onClick={prevSlide}
            className="w-12 h-12 rounded-full border-2 border-[#009999] flex items-center justify-center text-[#009999] hover:bg-[#009999]/10 transition-all duration-300"
            ...
            {[...Array(totalSlides)].map((_, index) => (
              <button
                ...
                className={`h-2 rounded-full transition-all duration-300 ${
                  index === currentSlide ? 'bg-[#009999] w-12' : 'bg-gray-400 w-2 hover:bg-gray-500'
                }`}
        ...
        <div className="text-center mt-20">
          <Link to="/contact">
          <button className="bg-[#009999] text-white px-10 py-5 rounded-lg font-semibold hover:bg-[#1a9b94] transition-all duration-300 shadow-xl transform hover:scale-105 text-lg" style={{ fontFamily: 'Lora, serif' }}>
