    ...
    <div style={styles.container}>
      ...
      <div style={styles.ctaSection}>
        <div style={styles.ctaContent}>
          <h2 style={styles.ctaTitle}>Need Electrical Services?</h2>
          <p style={styles.ctaText}>Get a free consultation and quote from our expert electricians</p>
          <button style={styles.ctaButton}>Schedule Appointment</button>
        </div>
      </div>
    </div>
  );
