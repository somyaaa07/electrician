        ...
        <div className="relative h-full flex items-center justify-start max-w-7xl">
          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 lg:p-7 max-w-xs sm:max-w-sm md:max-w-md lg:max-w-2xl shadow-2xl text-right">
            ...
            <h1 className="text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black leading-tight mb-3 xs:mb-4 sm:mb-5 text-slate-800 font-serif sm:mt-10 xl:mt-3 md:mt-5 lg:mt-6 mt-8">
              Professional <span style={{ color: '#20B2AA' }}>Electrical Services</span>
            </h1>
            ...
            <div className="flex justify-end gap-2 sm:gap-2.5 md:gap-3">
              <Link
                to="/services"
                className="bg-[#20B2AA] hover:bg-[#1a9994] text-white px-4 xs:px-5 sm:px-6 md:px-7 py-2 xs:py-2.5 sm:py-3 rounded-full text-[10px] xs:text-xs sm:text-sm font-bold transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
              >
                Our Services
              </Link>
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20">
            ...
            <div className="space-y-6 sm:space-y-8 lg:space-y-10">
              ...
              <div className="grid grid-cols-6 gap-2 w-28 sm:w-32">
                {[...Array(24)].map((_, i) => (
                  <div key={i} className="w-1.5 h-1.5 bg-[#20B2AA] rounded-full"></div>
                ))}
              </div>
              ...
              <div className="space-y-6 sm:space-y-8">
                ...
                <div className="flex flex-wrap gap-3 sm:gap-4">
                  <a href="#" className="w-10 h-10 sm:w-11 sm:h-11 rounded-full bg-slate-900 flex items-center justify-center text-white hover:bg-[#20B2AA] transition-all duration-300">
              ...
              <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 sm:px-5 py-3 sm:py-4 bg-gray-50 border border-gray-300 rounded-md text-slate-900 placeholder-slate-400 focus:outline-none focus:border-[#20B2AA] focus:ring-2 focus:ring-[#20B2AA]/20 focus:bg-white transition"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows="5"
                    className="w-full px-4 sm:px-5 py-3 sm:py-4 bg-gray-50 border border-gray-300 rounded-md text-slate-900 placeholder-slate-400 focus:outline-none focus:border-[#20B2AA] focus:ring-2 focus:ring-[#20B2AA]/20 focus:bg-white transition resize-none"
                  ></textarea>
                </div>

                <button
                  type="submit"
                  className="w-full py-3 sm:py-4 bg-[#20B2AA] hover:bg-[#1a9994] text-white rounded-md font-medium transition-all duration-300 transform hover:scale-[1.01] active:scale-[0.99] shadow-lg shadow-[#20B2AA]/30 text-sm sm:text-base"
                >
                  Send Your Message
                </button>
              </form>
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20">
            ...
            <div>
              <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold text-slate-900 mb-4 leading-tight font-serif">
                Customer<br />Questions & <span className="text-[#20B2AA]">Answers</span>
              </h2>
              ...
              <div className="bg-gray-50 backdrop-blur-sm rounded-xl p-3 sm:p-4 border border-gray-200">
                ...
                <div className="flex items-center space-x-3">
                  <div className="w-9 h-9 sm:w-10 sm:h-10 bg-[#20B2AA] rounded-lg flex items-center justify-center flex-shrink-0">
                    <svg
            ...
            <div className="space-y-3">
              {faqs.map((faq, index) => (
                <div 
                  key={index} 
                  className="bg-gray-50 border border-gray-200 rounded-lg overflow-hidden hover:border-[#20B2AA]/50 transition-all duration-300 shadow-sm"
                >
                  <button
                  ...
                  >
                    ...
                    <svg 
                      className={`w-5 h-5 text-[#20B2AA] transition-transform duration-300 flex-shrink-0 ${openFaq === index ? 'rotate-180' : ''}`} 
                      fill="none" 
                      stroke="currentColor" 
                      viewBox="0 0 24 24"
                    >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold text-slate-900 mb-4 font-serif">
              Find Us <span className="text-[#20B2AA]">Here</span>
            </h2>
